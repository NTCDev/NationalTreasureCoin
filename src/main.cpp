...
// Copyright (c) 2013 The NationalTreasureCoins developers
...
uint256 hashGenesisBlock("0x000005ccbc42004d1587a9fb5b7d2e1097298fc0e5aaa33451a1842d467f829f");
static const unsigned int timeGenesisBlock = 1456319538;
...
const string strMessageMagic = "NationalTreasureCoins Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "ParseHex in already databases we NationalTreasureCoins from USA with reindexing.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xcf10fcc021f68e84ccbca9e24d710b6bf2a27936b8f7bcd784fdde383f569c8e"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("NationalTreasureCoinsMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("NationalTreasureCoinsMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("NationalTreasureCoinsMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("NationalTreasureCoinsMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("NationalTreasureCoins-miner");
    ...
    try { loop {
        ...
        printf("Running NationalTreasureCoinsMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("NationalTreasureCoinsMiner terminated\n");
        throw;
    }
}
