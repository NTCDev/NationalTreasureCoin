...
const QString BITCOIN_IPC_PREFIX("NationalTreasureCoins:");
...
{
    QString name("NationalTreasureCoinsQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click NationalTreasureCoins: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start NationalTreasureCoins: click-to-pay handler");
    else
...
{
    // clicking on NationalTreasureCoins: URLs creates FileOpen events on the Mac:
